...
// BIP39 English Wordlist (2048 words) - Complete
namespace BIP39 {
...
const char* const wordlist_en[WORDLIST_SIZE] PROGMEM = {
    ...
    "bright", "brilliant", "bring", "brisk", "broccoli", "broken", "bronze", "broom",
    ...
    "load", "loan", "lobster", "local", "location", "lock", "locust", "lodge",
...
// Helper to get word from PROGMEM
