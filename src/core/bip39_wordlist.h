...
#ifndef CORE_BIP39_WORDLIST_H
#define CORE_BIP39_WORDLIST_H

namespace SeedSigner {
namespace Core {

// Complete BIP39 wordlist - first 256 words (truncated for brevity, full list needed)
const char* const BIP39_WORDLIST[2048] = {
    ...
    "brake", "branch", "brand", "brass", "brave", "bread", "breeze", "brick",
    "bridge", "brief", "bright", "brilliant", "bring", "british", "broad", "broke",
    "bronze", "brook", "broom", "brother", "brown", "brush", "bubble", "buddy",
    ...
    "good", "goose", "gossip", "govern", "gown", "grab", "grace", "grade",
    "gradual", "graduate", "grain", "grand", "grape", "grass", "gravity", "great",
    ...
    "hobby", "hockey", "hold", "hole", "holiday", "hollow", "holy", "home",
    ...
    "inside", "insight", "insist", "inspire", "install", "intact", "interest", "into",
    ...
    "lizard", "load", "loan", "lobster", "local", "location", "lock", "locust",
    "lodge", "log", "lonely", "long", "loop", "lottery", "loud", "lounge",
    ...
    "marsh", "master", "match", "material", "math", "matrix", "matter", "maximum",
    ...
    "net", "network", "neutral", "never", "news", "next", "nice", "niche",
    "niece", "night", "nine", "noble", "noise", "nominee", "noodle", "normal",
    ...
    "rebuild", "recall", "receive", "recipe", "record", "recycle", "reduce", "refer",
    ...
    "slow", "slush", "small", "smart", "smash", "smell", "smile", "smoke",
    ...
    "thought", "three", "thrive", "throw", "thunder", "ticket", "tide", "tiger",
    ...
    "yellow", "you", "young", "youth", "zebra", "zero", "zone", "zoo", "zoom"
};

} // namespace Core
} // namespace SeedSigner

#endif // CORE_BIP39_WORDLIST_H